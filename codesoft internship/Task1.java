...
public static void main(String[] args) {
    ...
    while(attempts<MAX_ATTEMPTS){
        ...
        if(guess_number==number){
            ...
            System.out.printf("Number Guessed successfully.Attempts=%d.Rround score=%d\n",attempts,score);
            break;
        }
        else if(guess_number<number){
            System.out.printf("The number is greater than %d.Attemts Left=%d.\n",guess_number,MAX_ATTEMPTS-attempts);

        }
        else if(guess_number>number){
            System.out.printf("The number is less than %d.Attemts Left=%d.\n",guess_number,MAX_ATTEMPTS-attempts);
